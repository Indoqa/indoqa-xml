...
public class AttributesImpl extends org.xml.sax.helpers.AttributesImpl {
    ...
    /**
     * Utility method to update the value of the named attribute. Returns an updated set of attributes instead of modifying the given
     * attribute set as the given value may be read-only.
     *
