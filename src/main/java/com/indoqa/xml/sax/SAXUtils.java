 ...
 * XML utility methods.
 *
 * @version $Id: SAXUtils.java 729283 2008-12-24 09:25:21Z cziegeler $
 */
public class SAXUtils {
    ...
    /**
     * Create a start and endElement with a empty Namespace and without Attributes The content of the Element is set to the stringValue
     * parameter
     *
     * @param localName The local name (without prefix)
     ...
     * @see #endElement(ContentHandler, String)
     */
    public static void createElementNS(ContentHandler contentHandler, String namespaceURI, String localName, String stringValue)
            throws SAXException {
     ...
     * @see org.xml.sax.Attributes
     */
    public static void createElementNS(ContentHandler contentHandler, String namespaceURI, String localName, Attributes atts)
            throws SAXException {
     ...
     */
    public static void createElementNS(ContentHandler contentHandler, String namespaceURI, String localName, Attributes atts,
            String stringValue) throws SAXException {
