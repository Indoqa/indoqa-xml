 ...
 * <p>
 * This class also provides a very convenient and safe way of handling namespace declarations in SAX pipes. It also allows to filter
 * duplicate namespace declarations that too often clutter up XML documents that went through several transformations, and avoid
 * useless namespace declarations that aren't followed by element events.
 * <p>
...
public class NamespacesTable {
    ...
    /**
     * The entry that start the prefix mappings for the scope that's about to be entered or was just left.
     */
     ...
     * <p>
     * When using {@link #enterScope()}/{@link #leaveScope()}, this method does nothing and always returns <code>null</code>, as
     * declaration removal is handled in {@link #leaveScope()}.
     *
     ...
     * <p>
     * Typically called in a SAX handler <em>before</em> sending a <code>startElement()</code> event.
     *
     * @since 2.1.8
     */
    ...
    /**
     * Start all declared mappings of the current scope and enter a new scope. This starts a new, empty list of declarations for the
     * new scope.
     * <p>
     * Typically called in a SAX handler <em>before</em> sending a <code>startElement()</code> event.
     *
    ...
    /**
     * Leave a scope. The namespace declarations that occured before the corresponding <code>enterScope()</code> are no more visible
     * using the resolution methods, but still available using {@link #getCurrentScopeDeclarations()} until the next call to
     * {@link #addDeclaration(String, String)} or {@link #enterScope()}.
     * <p>
     * Typically called in a SAX handler <em>after</em> sending a <code>endElement()</code> event.
     *
     * @since 2.1.8
     */
    ...
    /**
     * Return the URI associated with the given prefix or <b>null</b> if the prefix was not mapped.
     */
    ...
    /**
     * Return an array with all prefixes currently mapped to the specified URI. <br>
     * The array length might be <b>zero</b> if no prefixes are associated with the specified uri.
     *
    ...
    /**
     * Return one of the prefixes currently mapped to the specified URI or <b>null</b>.
     */
    ...
    /**
     * A namespace-aware name. (This interface is used in conjunction with <code>NamespacesTable</code>).
     */
    ...
    /**
     * A namespace declaration. (This interface is used in conjunction with <code>NamespacesTable</code>).
     */
